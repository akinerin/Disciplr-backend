...
analyticsRouter.get('/milestones/trends', authenticateApiKey([ApiScope.ReadAnalytics]), async (req, res) => {
...
analyticsRouter.get('/behavior', authenticateApiKey([ApiScope.ReadAnalytics]), async (req, res) => {
